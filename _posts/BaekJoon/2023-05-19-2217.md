---
title:  "[BOJ Python] 2217번 로프"
excerpt: "백준 온라인 저지 문제 풀이"

categories:
  - BaekJoon
tags:
  - [Python, Math, Greedy, Sorting]
...
- [C++ 풀이](https://hagisilecoding.tistory.com/29)
    ```cpp
    #include <iostream>
    #include <algorithm>
    using namespace std;
    ...
    int main() {
        const int MAX_LOOPS = 100001;
        long long loap[MAX_LOOPS];
...
- [Java 풀이](https://propercoding.tistory.com/296)
    ```java
