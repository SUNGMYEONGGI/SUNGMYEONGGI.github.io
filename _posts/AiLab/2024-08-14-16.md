---
title:  "[Computer Vision Project] 문서 타입 분류 Report"
excerpt: "[Computer Vision Project] 문서 타입 분류 Report"
...
| :--------------------------------------------------------------: | :--------------------------------------------------------------: | :--------------------------------------------------------------: | :--------------------------------------------------------------: | :--------------------------------------------------------------: |
| 팀장, 데이터증강, 모델링 | 오토인코더, Test데이터 디노이징 | 데이터 증강, efficientnet 계열 모델링 | 데이터 OCR | 모델링 테스트 |
